/*!
 * DESCP:			Driver file for fine-grained persistent hash table implemented using NVML. 
 * AUTHOR:			Ajay Singh, IIT Hyderabad 
 * ORGANIZATION: 	LIP6 - INRIA&UPMC.
 * DATE:			Jul 20, 2017.
 */
#include "ht-fine-plist.h"
...
main(int argc, char *argv[])
{
	...
	{
		pop = pool<pmem_ht>::create(path, LAYOUT, AJPMEMOBJ_MIN_POOL, CREATE_MODE_RW);
	} 
	else
	{
		pop = pool<pmem_ht>::open(path, LAYOUT);
	}
